...
`copilot-chat-exporter-plugin` module wraps it in an actual IntelliJ plugin
action.
...
1. Open `copilot-chat-reader/` as a Gradle project in IntelliJ, or build it
   as part of the root `copilot-chat-exporter` multi-project build.
